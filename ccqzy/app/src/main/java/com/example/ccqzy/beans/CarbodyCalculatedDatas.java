...
@Table(name = "carbodyCalculatedDatas")
public class CarbodyCalculatedDatas implements Serializable {
    ...
    public CarbodyCalculatedDatas() {
    }

    public CarbodyCalculatedDatas(String id, String measureInfoId, String measurePointId,
