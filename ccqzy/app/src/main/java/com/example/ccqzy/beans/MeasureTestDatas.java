...
@Table(name = "measureTest")
public class MeasureTestDatas implements Serializable {
    ...
    public MeasureTestDatas() {
    }

    public MeasureTestDatas(String id, String measureInfoId, String measurePointId,
