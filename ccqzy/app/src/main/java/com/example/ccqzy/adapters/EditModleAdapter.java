...
import com.example.ccqzy.activitys.DatInfosActivity;
...
public class EditModleAdapter extends BaseAdapter {
    private List<EditModle> name = new ArrayList<>();
    Context context;

    public EditModleAdapter(List<EditModle> name, Context context) {
        this.name = name;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.edit_modle_item, null);
        ...
        viewHolder.tvUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatInfosActivity.instance.itemUpDown(itemId1,order1,itemId2,order2);
                LogUtils.d("互换位置成功!!!");
